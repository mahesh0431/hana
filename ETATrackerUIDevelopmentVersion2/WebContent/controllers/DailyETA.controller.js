...
//					      jQuery.sap.require("sap.dev.user.papa.csvGenerator");
				...
				onSelectVariant:function(oEvent){
					if (oEvent.getParameter("key") == "ADMIN"){
						this.getView().byId("TCPRI").setVisible(false);
						this.getView().byId("TCCMP").setVisible(false);
						this.getView().byId("TCISUCS").setVisible(true);
						this.getView().byId("TCISACS").setVisible(true);
					}else{
						this.getView().byId("TCPRI").setVisible(true);
						this.getView().byId("TCCMP").setVisible(true);
						this.getView().byId("TCISUCS").setVisible(false);
						this.getView().byId("TCISACS").setVisible(false);
					}
